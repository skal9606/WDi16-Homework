...
#HOUSES
House.destroy_all
h1 = House.create :name => "Sugarloaf", :address => "28 Caldwell Street, Darlinghurst, Sydney, NSW, 2010", :blurb => "A lovely hole inner city hole in the wall", :about => "2 beds, 2 rooms", :availability => true, :owner => "Samwise Gamgee", :price => 400, :amenities => "Kitchen, TV, Internet", :house_rules => "Not suitable for pets",
...
h2 = House.create :name => "Mum's the word", :address => "24 Florey Avenue, Pymble, Sydney, NSW, 2073", :blurb => "A quiet and peaceful residence on the North Shore", :about => "1 bed, 1 room", :availability => true, :owner => "Rajni Kalra", :price => 300, :amenities => "Kitchen, TV, Internet", :house_rules => "Not suitable for old people",
...
h4 = House.create :name => "Inner west paradise", :address => "14A John Street, Hunters Hill, Sydney, NSW, 2110", :blurb => "An inner west beauty with waterfront access", :about => "Entire house", :availability => true, :owner => "John Johnson", :price => 800, :amenities => "Kitchen, TV, Internet", :house_rules => "Not suitable for people allergic to cats",
...
h1.comments << c1 << c2 << c3
h2.comments << c4 << c5 << c6
h3.comments << c7 << c8 << c9
h4.comments << c10 << c11 << c12
